<template>
    ...
    <div class="modal" id="modal-dispositivo">
      <div class="dialogo-modal">
        ...
        <div class="cuerpo-modal">
            ...
            <textarea v-model="dispositivo.descripcion" type="text" placeholder="Descripción" required></textarea>
            <label>Tipo</label>
  ...
  methods: {
    crear() {
      this.$emit('crear', this.dispositivo);
      // limpiar los campos
      this.dispositivo = {
        nombre_de_dispositivo: '',
        descripcion: '',
